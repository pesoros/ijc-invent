...
$(document).ready(function(){
    ...
    $("#addNewItem").click(function(e){
        ...
        if(!itemName || !itemQuantity || !itemCategory || !itemPrice || !itemCode){
        ...
        $.ajax({
            ...
            data:{itemName:itemName, itemQuantity:itemQuantity, itemPrice:itemPrice, itemDescription:itemDescription, itemCode:itemCode, itemCategory:itemCategory},
