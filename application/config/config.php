...
if(is_cli()){
    ...
    $config['base_url'] =  $protocol.$host."/invent/";
}

else{
    $allowed = ['www.ijc-distributor.pesoros.com','www.ijc-pos.pesoros.com'];//input all allowed urls here e.g. amirsanni.com, www.practa.ng, smartagapp.com
